...
if __name__ == '__main__':
    ...
    # 训练时改成 demo.train.config
    # 预测时改成 demo.decode.config

    args_list = [argparse.Namespace(config='demo.train.config'), argparse.Namespace(config='demo.decode.config')]
    # args_list = [argparse.Namespace(config='demo.decode.config')]
